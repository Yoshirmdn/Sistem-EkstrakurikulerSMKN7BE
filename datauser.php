    ...
    if($name && $email && $password && $user_type ){
        if($op == 'edit'){
            ...
            if($q1){
             ...
             $sqlceknis=mysqli_query($connect,"Select * from user_form where nis='$nis'");
...
<head><link href="img/lg.png" rel="shortcut icon">
  ...
  <title>Data Pengguna &mdash;System Informasi Ekstrakulikuler</title>
              ...
              <div class="col-12">
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group col-6">
                     ...
                     <div class="form-group col-6">
                        <label for="jk">Type</label>
                        <input type="text"id="user_type" name="user_type"value="<?php echo $user_type?>" class="form-control"  >
                    </div>
                  ...
                  <div class="card-header">
                    ...
                    <h4>Data User Ekstrakulikuler</h4>
                        ...
                        <thead>                                 
                          ...
                          <tbody>  
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="datauser.php?op=edit&id=<?php echo $id?>" class="btn btn-icon btn-warning"><i class="far fa-edit"></i>Edit</a>
       
                                <a href="datauser.php?op=delete&id=<?php echo$id?>"onclick="return confirm('Yakin Delete Data?')" class="btn btn-icon btn-danger"><i class="fas fa-times"></i>Hapus</a>
