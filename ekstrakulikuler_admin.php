...
if($op == 'delete'){
    $id     =$_GET['id'];
    $sql1   ="delete from eskul where id = '$id'";
    $q1 =mysqli_query ($connect,$sql1);
    if($q1){
        echo "<script>alert('data berhasil di hapus');window.location='ekstrakulikuler_admin.php';</script>";
        ...
        <section class="section">
          ...
          <div class="section-body">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  <form method="post" class="needs-validation" novalidate=""action="tambah.php" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">                               
                          ...
                          <div class="form-group col-md-6 col-12">
                            ...
                            <input type="text" class="form-control"name="ig" value="" required="" id="ig">
                            <div class="invalid-feedback">
                        ...
                        <div class="row">
                          <div class="form-group col-md-6 col-12" >
                            ...
                            <input type="file"class="form-control"id="foto"name="foto" value=""maxlength="10">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-6">
                            ...
                            <textarea class="form-control summernote-simple" name="deskripsi" id="deskripsi"></textarea>
                          </div>
                          <div class="form-group col-6">
                            <label>Ringkasan</label>
                            <textarea class="form-control summernote-simple" name="ringkasan" id="ringkasan" maxlength="10"></textarea>
                          </div>
                        </div>
                      ...
                      <table class="table table-bordered table-striped" id="table-1">
                        <thead>                                 
                          ...
                          <tbody>  
                            <?php
                            include "koneksi.php";
                            $sql2 ="select * from eskul order by id desc";
                            ...
                            <tr>
                                ...
                                <td><?php echo $ig?></td>
                                <td><?=substr($rinigkasan,0,100)?></td>
                                <td ><?php echo substr( $deskripsi,0,100)?></td>
                                <td>Foto <br><img src="foto/eskul/<?php echo $foto?>"width="100px" alt="">
                                <br><br>Logo<br>
                                <img src="foto/eskul/<?php echo $logo?>"width="100px" alt=""></td>
                                <td>
                                <a href="ekstrakulikuler_edit.php?id=<?php echo $id?>" class="btn btn-icon btn-warning"><i class="far fa-edit"></i>Edit</a>
       
                                <a href="ekstrakulikuler_admin.php?op=delete&id=<?php echo$id?>"onclick="return confirm('Yakin Delete Data?')" class="btn btn-icon btn-danger"><i class="fas fa-times"></i>Hapus</a>
      ...
      <div class="modal fade" id="pramuka" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog  modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <img alt="image" src="assets/img/news/pramuka1.jpg "title="Paskibra SMKN 7 Baleendah" 

              class="img-fluid" width="30%" style="float :left; margin-right :10px; margin-bottom: 5px;"> 
