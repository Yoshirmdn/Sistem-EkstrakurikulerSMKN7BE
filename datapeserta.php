...
if(isset($_POST['simpan'])){
    ...
    if($nis && $nama && $kelas && $ekskul && $jk && $tmp_lahir && $tgl_lahir && $no_hp && $alamat){
        if($op == 'edit'){
            $sql1 ="update data_peserta set nis = '$nis',nama='$nama',kelas='$kelas',ekskul='$ekskul',jk='$jk',tmp_lahir='$tmp_lahir',tgl_lahir='$tgl_lahir',no_hp='$no_hp',alamat='$alamat' where id = '$id'";
            $q1 =mysqli_query($connect,$sql1);
            if($q1){
              ...
              <div class="col-12">
                ...
                <form action="" method="POST">
                    <div class="form-group col-6">
                        ...
                        <input type="text" id="nis" name="nis" value="<?php echo $nis?>" class="form-control" >
                    </div>
                    <div class="form-group col-6">
                   ...
                   <div class="form-group col-6">
                     ...
                     <div class="form-group col-6">
                        ...
                        <input type="text"id="jk" name="jk"value="<?php echo $jk?>" class="form-control"  >
                    </div>
                     <div class="form-group col-6">
                     ...
                     <div class="form-group col-6">
                        ...
                        <input type="numbeer"id="no_hp" name="no_hp"value="<?php echo $no_hp?>" class="form-control"  >
                    </div>
                     <div class="form-group col-6">
                        ...
                        <thead>                                 
                          ...
                          <tbody>  
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="datapeserta.php?op=edit&id=<?php echo $id?>" class="btn btn-icon btn-warning"><i class="far fa-edit"></i>Edit</a>
       
                                <a href="datapeserta.php?op=delete&id=<?php echo$id?>"onclick="return confirm('Yakin Delete Data?')" class="btn btn-icon btn-danger"><i class="fas fa-times"></i>Hapus</a>
